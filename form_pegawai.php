...
?>
  ...
  <form method="POST" action="controller_pegawai.php">
    ...
    <div class="form-group row">
      ...
      <div class="col-8">
        <input id="nip" name="nip" type="text" value="<?= e($rs['nip']) ?>" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="nama" class="col-4 col-form-label">Nama</label>
      <div class="col-8">
        <input id="nama" name="nama" value="<?= e($rs['nama']) ?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-8">
        <input id="tmp" name="tmp" value="<?= e($rs['tempat_lahir']) ?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="tgl" class="col-4 col-form-label">Tanggal Lahir</label>
      <div class="col-8">
        <input id="tgl" name="tgl" value="<?= e($rs['tanggal_lahir']) ?>" type="date" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        <select id="jabatan" name="jabatan" class="custom-select">
          ...
          ?>
            <option value="<?= e($jab['id']) ?>" <?= $sel ?>><?= e($jab['nama']) ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        <select id="divisi" name="divisi" class="custom-select">
          ...
          ?>
            <option value="<?= e($div['id']) ?>" <?= $sel ?>><?= e($div['nama']) ?></option>
          <?php } ?>
        </select>
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-8">
        <textarea id="alamat" name="alamat" cols="40" rows="5" class="form-control"><?= e($rs['alamat']) ?></textarea>
      </div>
    </div>
    <div class="form-group row">
      <label for="email" class="col-4 col-form-label">Email</label>
      <div class="col-8">
        <input id="email" name="email" value="<?= e($rs['email']) ?>" type="text" class="form-control">
      </div>
    </div>
    <div class="form-group row">
      <label for="foto" class="col-4 col-form-label">Foto</label>
      <div class="col-8">
        <input id="foto" name="foto" type="text" value="<?= e($rs['foto']) ?>" class="form-control">
      </div>
    </div>
    <div class="form-group row">
