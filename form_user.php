...
//mode edit: username & password tidak boleh diubah (kosongkan password)
$dis = !empty($idedit) ? 'readonly' : '';
?>
<h3>Add User</h3>
<form method="POST" action="controller_user.php">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="nama" name="fname" value="<?= e($rs['fullname']) ?>" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-4 col-form-label" for="nama">Username</label>
        <div class="col-8">
            <input id="nama" name="uname" <?= $dis ?> value="<?= e($rs['username']) ?>" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-4 col-form-label" for="nama">Password</label>
        <div class="col-8">
            <input id="nama" name="pwd" <?= $dis ?> value="" placeholder="Kosongkan jika tidak ingin mengubah password" type="password" class="form-control">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="nama" name="email" value="<?= e($rs['email']) ?>" type="email" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-4 col-form-label" for="nama">Foto</label>
        <div class="col-8">
            <input id="nama" name="foto" value="<?= e($rs['foto']) ?>" type="text" class="form-control">
        </div>
    </div>
    <div class="form-group row">
