        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?= e($pel['jabatan']) ?></td>
                    <td><?= e($pel['materi']) ?></td>
                    <td><?= e($pel['tgl_mulai']) ?></td>
                    <td><?= e($pel['tgl_akhir']) ?></td>
                    <td><?= e($pel['keterangan']) ?></td>
                    <td>
                        <a href="index.php?hal=form_pelatihan&idedit=<?= e($pel['id']) ?>" type="button" class="btn btn-warning">Edit</a>
                    </td>
                </tr>
            <?php $no++;
            } ?>
